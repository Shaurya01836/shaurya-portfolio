...
const Blogs = () => {
  ...
  return (
    ...
    >
      ...
      {error && !loading && (
        <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-solid border-red-200 dark:border-red-900/50 rounded-md bg-red-50/50 dark:bg-red-900/10 animate-fade-in-up w-full">
      ...
      {!loading && !error && blogs.length === 0 && (
        <div className="flex flex-col items-center justify-center py-10 text-center border-2 border-solid border-gray-200 dark:border-[#1F1F1F] rounded-md bg-gray-50/50 dark:bg-[#161b22]/50 animate-fade-in-up w-full">
