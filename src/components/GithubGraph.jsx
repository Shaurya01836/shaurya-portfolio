...
const GithubGraph = ({ darkMode }) => {
  return (
    <div className="flex flex-col w-full gap-2 text-black dark:text-white p-4 md:p-8">
      ...
      <div className="border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-md p-4 shadow-sm w-full flex justify-center items-center overflow-hidden bg-white dark:bg-[#161b22]">
